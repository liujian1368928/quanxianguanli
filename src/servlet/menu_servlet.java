...
public class menu_servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		jiaosequanxian qhjs=new jiaosequanxian();
     	HttpSession session=request.getSession();		
		Object jid=session.getAttribute("jid");//获取login_servlet的jid
		if(jid==null)
		{
		...
		ArrayList<menu> list=me.getmenu(jid.toString());
		session.setAttribute("menulist",list);
		//request.setAttribute("menulist",list);//左边导航栏显示到Index2
